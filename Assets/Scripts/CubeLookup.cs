...
// Credit to dwilliamson on github for the triangulation tables:
...
public static class CubeLookup
{
	...
	public static readonly Vector3[] marchVertices = {
	...
	public static readonly Vector3[] marchEdges = {
		new Vector3(0,      0,      0),
		new Vector3(1,      0,      0),
		new Vector3(0,      1,      0),
		new Vector3(0,      0,      0),
	...
	public static readonly Vector3[] marchLerps = {
		new Vector3(0.5f,   0,      0),
		new Vector3(0,      0.5f,   0),
		new Vector3(0.5f,   0,      0),
		new Vector3(0,      0.5f,   0),
	...
	public static readonly Vector3Int[] EdgeVertices = {
